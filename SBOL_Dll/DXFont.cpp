...
DXFont::DXFont(HFONT hFont, LPDIRECT3DDEVICE8 pd3dDevice)
{
	InitializeValues();
...
HRESULT DXFont::SetFont(HFONT hFont)
{
	if (hFont)
	{
		if(m_hFont)
...
HRESULT DXFont::DrawText(FLOAT sx, FLOAT sy, DWORD dwColor, char* strText, DWORD dwFlags)
{
...
HRESULT DXFont::InitDeviceObjects(LPDIRECT3DDEVICE8 pd3dDevice)
{
	HRESULT hr;
...
HRESULT DXFont::RestoreDeviceObjects()
{
	HRESULT hr;
...
HRESULT DXFont::InvalidateDeviceObjects()
{
	SAFE_RELEASE(m_pVB);
...
HRESULT DXFont::DeleteDeviceObjects()
{
